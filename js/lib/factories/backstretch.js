...
/**
    ...
    * Usage: Angular: app.run('module.backstretch.generateBanner', [source,destination]);, Internal: backstretch.generateBanner(source, destination);
...
*/
app.factory('backstretch', function(){
  var backstretch = {
    options : {
